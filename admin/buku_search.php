	...
	<div id="menu-tengah">
        ...
        <div id="menu_header">
           ...
           <tbody>
                ...
                <td align="center"><a href="?page=edit-buku&id=<?php echo $data['id']; ?>"><img src="../images/edit1.png"/ width="25px" height="20px"></a></td>
                <td align="center"><a href="?page=hapus-buku&id=<?php echo $data['id']; ?>" onclick="return confirm('Anda yakin ingin menghapus data buku <?php echo $data['judul']; ?> ?')"><img src="../images/delete2.jpg"/ width="25px" height="20px"></a></td>
