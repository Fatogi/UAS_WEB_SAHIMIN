	...
	<div id="menu-tengah">
        ...
        <div id="menu_header">
        	...
        	<table width="100%" height="100%" style="border:1px solid #9cc;">
            	<tr>
                	<td width="50%"><a href="?page=anggota_input">TAMBAH DATA</a></td>
           ...
           <tbody>
                ...
                <td align="center"><a href="?page=edit-anggota&nim=<?php echo $data['nim'];?>"><img src="../images/edit1.png"/ width="25px" height="20px"></a></td>
                <td align="center"><a href="?page=hapus-anggota&nim=<?php echo $data['nim']; ?>" onclick="return confirm('Anda yakin ingin menghapus Anggota <?php echo $data['nama']; ?> ?')"><img src="../images/delete2.jpg"/ width="25px" height="20px"></a></td>
              </tr>
