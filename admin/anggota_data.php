	...
	<div id="menu-tengah">
        ...
        <div id="menu_header">
        	...
        	<table width="100%" height="100%" style="border:1px solid #9cc;">
            	<tr>
                	<td width="50%"><a href="?page=anggota_input">Input Data</a></td>
   	    ...
   	    <div class="zebra-table">
			...
			?>
   	        <tbody>
                ...
                <td align="center"><a href="?page=anggota_edit&nim=<?php echo $data['nim'];?>"><img src="../images/edit1.png"/ width="25px" height="20px"></a></td>
                <td align="center"><a href="?page=anggota_hapus&nim=<?php echo $data['nim']; ?>" onclick="return confirm('Anda yakin ingin menghapus Anggota <?php echo $data['nama']; ?> ?')"><img src="../images/delete2.jpg"/ width="25px" height="20px"></a></td>
              </tr>
